...
<figure><picture><source srcset="../.gitbook/assets/UNIT Vault white version.png" media="(prefers-color-scheme: dark)"><img src="../.gitbook/assets/UNIT Vault dark version.png" alt=""></picture><figcaption><p>A UNIT Vault</p></figcaption></figure>
